                ...
                <form id="formRegistro" role="form" method="POST" action="RegistrarVacancia">
                    <div class="row">
                        <div class="form-group col-xs-12">                               
                            ...
                            <select class="form-control input-sm " id="programa" name="programa" onchange="actualizaCategoria()" required data-ent="${dataEntidad1}" data-sub="${dataSubsistema1}" data-pla="${dataPlantel1}">                                  
