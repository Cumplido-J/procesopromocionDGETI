...
//----------------------------------------------------------------------------
    if (document.getElementById("entidad").value == "0" && ver == 1)
    {
        return false;
    } else {
    }
//----------------------------------------------------------------------------
    ...
    if (document.getElementById("i_plantel").value == "0" && ver == 1)
    {
        return false;
    } else {
    }
//----------------------------------------------------------------------------
    ...
    if (document.getElementById("programa").value == "" && ver == 1)
    {
        return false;
    } else {
    }
