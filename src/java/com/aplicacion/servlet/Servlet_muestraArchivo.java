    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(request.getParameter("k")!=null){
                ...
                ruta="C:/ArchivosPromocion/"+id+"_REMA940831BA4.PDF";
            }else if(request.getParameter("e")!=null){
                id=request.getParameter("e").toString();
                ruta="C:/ArchivosPromocion/ejemplos/registro/"+id+".PDF";
            }
            ...
            if(documento.exists()){
                ...
                PrintWriter out = response.getWriter();
                response.setContentType("text/html;charset=UTF-8");
                out.println("<h1>El archivo "+ruta+id+" solicitado no existe</h1>");
                out.close();
            }
        } finally {
