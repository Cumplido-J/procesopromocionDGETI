 ...
 * @author charl
 */
@WebServlet(name = "Servlet_regresar2", urlPatterns = {"/Servlet_regresar2"})
public class Servlet_regresar2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_regresar2</title>");
            out.println("</head>");
            out.println("<body>");
