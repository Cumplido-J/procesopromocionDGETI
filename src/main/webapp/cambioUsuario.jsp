    ...
    <body>
        ...
        <c:if test='${sessionScope["rol"]!="S"}'>
            ...
            <c:if test='${sessionScope["plantel"]!=null}'>
                <c:set var="disabled4" value="2"></c:set>
            </c:if>
        </c:if>
                    <c:if test='${sessionScope["subsistema"]!=""}'>
                <c:set var="disabled2" value="disabled"></c:set>
               <c:set var="subsistema_" value="${sessionScope['subsistema']}"></c:set>
            </c:if>
        <main class="page">
                ...
                <form id="formRegistro" role="form" method="POST" action="RegistrarUsuario">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">                               
                            ...
                            <select class="form-control input-sm ${disabled2}" id="subsistema" data-subsistema="${subsistema_}" name="subsistema" onchange="actualizarPlanteles()" required>                                  
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">                               
                            ...
                            <input type="text" class="form-control input-sm" name="correo" id="correo" value="${informacion[6]}" maxlength="50" required/>
