                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="form-control input-sm" id="categoriaAspira" name="categoriaAspira" onchange="cambioCategoriaAspira()" required>                                     
                                     ${catalogo.desplegarOpcionesCategoriasVacantes(Docente.infoRegistro[6],Docente.infoRegistro[64],Docente.infoRegistro[42],Docente.infoRegistro[78],Docente.infoRegistro[77])}
                                  </select>
                                </div>
                                <div class="form-group col-md-3">
