 ...
 * @author charl
 */
@WebServlet(name = "Servlet_modificar_convocatoria", urlPatterns = {"/Servlet_modificar_convocatoria"})
public class Servlet_modificar_convocatoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_modificar_convocatoria</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlet_modificar_convocatoria at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session.getAttribute("idUsuario") != null && session.getAttribute("rfc") != null) {
                ...
                String btnregresa = request.getParameter("modificar_convocatoria");
                if (btnregresa != null) {
