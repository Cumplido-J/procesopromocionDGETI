 ...
 * @author jtrinidadl
 */
@WebServlet(name = "AltaConvocatoriaBase", urlPatterns = {"/AltaConvocatoriaBase"})
public class Servlet_cbAltaConvocatoriaBase extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("idUsuario")!=null){            
            ...
            RequestDispatcher rd= sc.getRequestDispatcher("/altaConvocatoriaBase.jsp");            
