 ...
 * @author charl
 */
@WebServlet(name = "Servlet_P_Vacancia", urlPatterns = {"/Servlet_P_Vacancia"})
public class Servlet_P_Vacancia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_P_Vacancia</title>");
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session.getAttribute("idUsuario") != null && session.getAttribute("rfc") != null) {
                ...
                String nac1 = request.getParameter("nacional");
                ...
                if (btnregresa != null) {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("agregar_vacancia.jsp");
                    rd.forward(request, response);
                }
                } else {
