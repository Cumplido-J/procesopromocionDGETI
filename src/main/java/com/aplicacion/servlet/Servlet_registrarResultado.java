            ...
            if(request.getParameter("id")==null){
                ...
                if(!datos.isEmpty()){
                    if(datos.get(0)[0].equals("ok")){
                        ...
                        String[] info=new CriteriosValoracion().getFilasResultados(idUsuario,vistaAdmin,idPermiso,session.getAttribute("permisoActualEdicion").toString(),permisoTablaUsuarioEdicion);
