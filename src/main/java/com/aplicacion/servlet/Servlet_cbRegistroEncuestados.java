 ...
 * @author David Reyna
 */
@WebServlet(name = "RegistroEncuestados", urlPatterns = {"/RegistroEncuestados"})
public class Servlet_cbRegistroEncuestados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_cbRegistroEncuestados</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlet_cbRegistroEncuestados at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
