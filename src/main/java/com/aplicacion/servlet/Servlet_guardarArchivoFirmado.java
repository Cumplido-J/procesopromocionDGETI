 ...
 * @author jtrinidadl
 */
@WebServlet(name = "GuardarArchivoFirmado", urlPatterns = {"/GuardarArchivoFirmado"})
public class Servlet_guardarArchivoFirmado extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            try{
                Part archivo=request.getPart("archivo1");
            ...
            ruta+="/"+idUsuario+"_"+idRequisito+"_CartaAceptacion+.pdf";
