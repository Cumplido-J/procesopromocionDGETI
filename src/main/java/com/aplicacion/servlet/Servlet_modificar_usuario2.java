 ...
 * @author charl
 */
@WebServlet(name = "Servlet_modificar_usuario2", urlPatterns = {"/Servlet_modificar_usuario2"})
public class Servlet_modificar_usuario2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_modificar_usuario2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlet_modificar_usuario2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
       ...
       response.setContentType("text/html;charset=ISO-8859-1");
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session.getAttribute("idUsuario") != null && session.getAttribute("rfc") != null) {
                ...
                String btnlogin = request.getParameter("modificar");

                if (btnlogin != null) {
                    request.setAttribute("id",btnlogin);
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("modificar_usuario2.jsp");
