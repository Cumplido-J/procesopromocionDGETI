<%-- 
    Document   : recuperar_contraseña_vacancia
    Created on : 08-jun-2020, 16:16:01
    Author     : charl
--%>
...
<html>
    ...
    <body>
        ...
        <div class="padre">
            ...
            <div class="ruta">
                <p> UEMSTIS > Promoción Docente > Recuperar Contraseña Vacancia</p>
            </div>
            <section class="sectionart">
                <div class="articulosart">
                    <h3>Recuperar Contraseña Vacancia</h3>	
                    <form class="form-horizontal" role="form" method="POST" action="Servlet_recuperarclave_vacancia">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button class="btn btn-primary pull-right" type="submit" name="recuperarclavevacancia">Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
