    ...
    <body>  
        ...
        <form class="form-horizontal" role="form" method="POST" action="Servlet_guardar_vacancia">
            ...
            <div class="modal">
                <div class="contenido">
                    <br>
                    <input class="aviso_guardar" type="text" name="aviso_guardar_vacancia" id="aviso_guardar_vacancia" value="<%=request.getAttribute("nom")%>">
                     <%
                            session.setAttribute("idUsuario", idUsuario);
                            session.setAttribute("rfc", rfc);
                        %>
            ...
            <input type="submit" value="Enviar" name="guardar" id="ventana3" >
        </form> <%
            } else {
