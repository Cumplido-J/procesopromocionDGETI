<%-- 
    Document   : recuperar_contraseñas
    Created on : 01-jun-2020, 15:01:15
    Author     : charl
--%>
...
<html>
    ...
    <body>
        ...
        <div class="padre">
            ...
            <div class="ruta">
                <p> UEMSTIS > Promoción Docente > Recuperar Contraseña</p>
            </div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="Servlet_recuperarclave">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button class="btn btn-primary pull-right" type="submit" name="recuperarclave">Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
