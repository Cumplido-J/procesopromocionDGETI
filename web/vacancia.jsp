<%-- 
    Document   : vacancia
    Created on : 05-jun-2020, 16:05:20
    Author     : charl
--%>
...
<html>
    ...
    <body>
        ...
        <div class="padre">
            ...
            <div class="ruta">
                <p> UEMSTIS > Promoción Docente > Agregar Vacancia</p>
            </div>
            <section class="sectionart">
                <div class="articulosart">
                    <h3>Carga de Vacancia en los Planteles</h3>	
                    <form class="form-horizontal" role="form" method="POST" action="Servlet_iniciosesion_vacancia">
                            ...
                            <div class="col-sm-offset-3 col-sm-9">
                                <divlog class="divlog">
                                    ...
                                    <divOlvide class="divOlvide">
                                        <a href="recuperar_contraseña_vacancia.jsp">Olvidé mi contraseña</a>
                                    </divOlvide>
                                </divlog>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button class="btn btn-primary pull-right" type="submit" name="iniciarsesionvacancia">Enviar</button>
                            </div>
                            <div class="col-sm-offset-3 col-sm-9">
                                <a href="RegPart.html"><button class="btn btn-primary pull-right" type="button">Regístrate aquí</button></a>
                            </div>
                        </div>
                    </form>
                </div>
