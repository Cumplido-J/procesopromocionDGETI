...
<html lang="es">
    <head>
        <title>Evidencias Registro</title>
        <meta charset="UTF-8"/>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      1. Antiguedad <p id="demo"></p>
                      </a>
                    </h4>
                    <button type="button" class="collpase-button collapsed" data-parent="#accordion" data-toggle="collapse" href="#infoAntiguedad"></button>
                  </div>
                  <div class="panel-collapse collapse" id="infoAntiguedad">
                    <div class="panel-body">
                      <form id="formInfoAntiguedad" role="form" method="POST" action="evidenciaRegistro.jsp">
                          <div class="form-group col-md-6">                               
                              <label class="control-label" for="antiguedad">Antiguedad</label>
                              <select class="form-control input-sm" id="mySelect" onchange="mySeccion1()"name="antiguedad" required>                                  
                                  ${catalogo.desplegarAntiguedad()}
                              </select>
                            </div>
                        <div class="form-group col-md-6">
                          <label class="control-label" for="evidencia1">Cargar de constancia de antiguedad:</label>
                          <input type="file" class="form-control input-sm" id="evidencia7" name="evidencia1" >
                        </div>
                          <br>
                    ...
                    <div class="panel-body">
                      <form role="form" method="POST" action="evidenciaRegistro.jsp">
                          <div class="form-group col-md-6">                               
                              ...
                              <select class="form-control input-sm" id="mySelect2" onchange="mySeccion2()" required>                                  
                                  ${catalogo.desplegarExperiencia()}
                              </select>
                            </div>
                        <div class="form-group col-md-6">
                          <label class="control-label" for="evidencia7">Cargar de constancia de experiecia</label>
                          <input type="file" class="form-control input-sm" id="evidencia7" name="evidencia7" >
                        </div>
                          <br>
                        <div class="col-xs-12 text-right">
                          <button class="btn btn-sm btn-primary" type="reset">Limpiar</button>
                    ...
                    <div class="panel-body">
                      <form role="form" method="POST" action="evidenciaRegistro.jsp">
                         <div class="form-group col-md-6">
                          ...
                          <select class="form-control input-sm" name="gradoAcademico" id="mySelect4" onchange="mySeccion4()">
                            ${catalogo.desplegarNivelAcademico()}
                          </select>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="panel-body">
                      <form role="form">
                        ...
                        <div>
                          ...
                          <select class="form-control input-sm" id="myCapacitacion" name="horasCurso" onchange="mySeccion5()">
                            ${catalogo.desplegarCapacitacion()}
                          </select>
                        </div>
                  ...
                  <div class="panel-body" id="infoMejoraContinua">
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      ...
                      <form role="form">
                        ...
                        <div class="form-group col-md-12">
                          <label class="control-label" for="evidencia6">Carga de constancia de horas frente a grupo:</label>
                          <input type="file" class="form-control input-sm" id="evidencia6" name="evidencia6" >
                        </div> 
                        <div class="col-xs-12 text-right">
                          <button class="btn btn-sm btn-primary" type="reset">Limpiar</button>
                          <button class="btn btn-sm btn-primary" type="submit">Guardar y continuar</button>
                  ...
                  <div class="panel-heading">
                    <h4 class="panel-title">
                      <a data-parent="#accordion" data-toggle="collapse" href="#infoParticipacion" aria-expanded="true" aria-controls="infoParticipacion">
                          </a>7. Participación en eventos y actividades
                    </h4>
                    ...
                    <div class="panel-body">
                      <form role="form">
                        <div id="content" class="form-group col-md-6">
                          ...
                          <select class="form-control input-sm" id="content1" name="horasCurso">
                            <option>-Seleccione Numero de participaciones-</option>
                            <option value='1'>1 participaciones</option>
                            <option value='2'>2 participaciones</option>
                            <option value='3'>3 participaciones</option>
                            <option value='4'>4 participaciones</option>
                            <option value='5'>5 participaciones o más</option>
                          </select>
                        </div>                
                        <div class="form-group col-md-6">
                            <div id="content" >
                    ...
                    <div class="panel-body">
                      <form role="form">
                        <div id="content" class="form-group col-md-6">
                          ...
                          <select class="form-control input-sm" id="mySelect8" name="opc8" onchange="mySeccion8()">
                            ${catalogo.desplegarPeriodoTutoria()}
                          </select>
                        </div>
                          <div class="form-group col-md-6">
                    ...
                    <div class="panel-body">
                      <form role="form" method="POST" action="evidenciaRegistro.jsp">                        
                        <div class="checkbox col-xs-6">
                          <label><input type="checkbox" checked="true" name="funcionesOtro" id="myCheckBox" onchange="mySeccion10()">10.A Planeación didáctica entregada</label>
                        </div>
                        <div class="checkbox col-xs-6" style="margin-top: 10px;">
                          <label><input type="checkbox" checked="true" name="activoServicio" id="myCheckBox1" onchange="mySeccion10()">10.AB Portafolio de evidencias</label>
                        </div>
                          <div class="form-group col-md-6">
                          <label class="control-label" for="modalidad">10.2A Observacion en el aula:</label>
                          <select class="form-control input-sm" name="modalidad" id="mySelectDesem10" onchange="mySeccion10()">
                            ${catalogo.desplegarDesempeno()}
                          </select>
                        </div>
                         <div class="form-group col-md-6">
                          <label class="control-label" for="a">10.3A Porcentaje de aprobación escolar:</label>
                          <select class="form-control input-sm" name="a" id="mySelect10" onchange="mySeccion10()">
                            ${catalogo.desplegarPorcentajeAprobacion()}
                          </select>
                         </div>
                          <div class="form-group col-md-6">
                          <label class="control-label" for="b">10.4A Nivel de desempeño:</label>
                          <select class="form-control input-sm" name="b" id="mySelectDictamen10" onchange="mySeccion10()">
                            ${catalogo.desplegarDesempeno()}
                          </select>
                         </div>
                          <div class="form-group col-md-6">
                          <label class="control-label">10.4A Evidencia de resultados educativos:</label>
                          <select class="form-control input-sm" id="myEvidencias" onchange="mySeccion10()">
                            ${catalogo.desplegarEvidencias()}
                          </select>
                         </div>
                        <div class="form-group col-md-12">
                          <label class="control-label" for="evidencia7">Carga de constancia de compatibilidad:</label>
                          <input type="file" class="form-control input-sm" id="evidencia7" name="evidencia7" >
                        </div> 
                        <div class="col-xs-12 text-right">
                          <button class="btn btn-sm btn-primary" type="reset">Limpiar</button>
